...
def run_full_training_pipeline(
    ...
    df_clean = preprocess_dataset(
        input_path=raw_data_path, output_path=processed_data_path, sample_size=sample_size
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="RevuMind V2 Model Training Pipeline Orchestrator"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=10000,
        help="Subset size for quick training runs. Use 0 for full run.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Minimum helpfulness votes required for regressor training",
    )
