...
REVIEW_TEMPLATES = [
    ...
    (
        ...
        "Very disappointed with the battery life for this price.",
        -1,
        "battery",
    ),
    (
        "Battery life is terrible. Had to charge {n} times a day. "
        "Defective product or very poor quality cells used.",
        -1,
        "battery",
    ),
    ...
    (
        ...
        "Best camera I have used in this price range.",
        +1,
        "camera",
    ),
    # Build/defect
    ...
    (
        ...
        "Returning immediately. Poor quality control.",
        -1,
        "defect",
    ),
    (
    ...
    (
        ...
        "Has survived drops multiple times without damage.",
        +1,
        "build",
    ),
    # Delivery
    (
        ...
        "Product inside also scratched. Terrible packaging.",
        -1,
        "delivery",
    ),
    (
        "Delivery took {n} extra days. No tracking updates. " "Very poor logistics experience.",
        -1,
        "delivery",
    ),
    (
        "Super fast delivery. Arrived in {n} days. " "Packaging was excellent. Very impressed.",
        +1,
        "delivery",
    ),
    # Software/app
    (
        ...
        "Software is full of bugs. Completely unusable.",
        -1,
        "software",
    ),
    (
        "App is slow and outdated. No updates in {n} months. "
        "Competitors have much better apps.",
        -1,
        "software",
    ),
    (
        "App works perfectly. Intuitive interface. " "Regular updates with new features. Love it.",
        +1,
        "software",
    ),
    # Value
    (
        ...
        "for less money. Not worth the premium price.",
        -1,
        "value",
    ),
    (
        "Excellent value for money. Better than alternatives "
        "costing {n} percent more. Highly recommend.",
        +1,
        "value",
    ),
    # Positive overall
    ...
    ("Perfect in every way. Five stars. " "Best purchase I have made this year.", +1, "general"),
    # Competitive
    (
        "Switched from CompetitorBrand and this is so much better. "
        "No comparison. This wins on every metric.",
        +1,
        "comparison",
    ),
    (
        "Was using BrandX before this. Huge downgrade. " "Going back to my old device.",
        -1,
        "comparison",
    ),
]
