...
class ReviewEmbeddingsExtractor:
    ...
    def extract_embeddings(self, texts: Union[str, List[str]], is_training: bool = False) -> np.ndarray:
        """
        ...
        if self.use_transformer:
            ...
            if is_training:
                ...
                try:
                    ...
                    logger.warning("TF-IDF vectorizer was not fitted. Running fit_transform as fallback...")
                    vectors = self.model.fit_transform(texts).toarray()
